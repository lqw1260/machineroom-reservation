<template>
    <div>
        <el-card shadow="always" class="bodyStyle">
            ...
            <div >
                查看周数
                <el-select v-model="weekNumber" placeholder="请选择" @change="weekSelect">
                    <el-option
            ...
            <div class="reserveCard">
                ...
                <div class="reservationStatus">
                    ...
                    <div class="info" v-if="!!periodCourseInfo.courseName">
                        ...
                        <p>申请人联系方式:&nbsp;&nbsp;{{ periodCourseInfo.applicantContact }}</p>
                    </div>
...
export default {
    data(){
        return{
            ...
            tableCol:['serialNumber','time','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday'],
            tableColLabel:['序号','时间','周一','周二','周三','周四','周五','周六','周日'],
